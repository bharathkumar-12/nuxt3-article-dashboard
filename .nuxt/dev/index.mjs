...
const assets = {
  "/index.mjs": {
    ...
    "etag": "\"22a31-wDqEN0Y3bXAtEJvUSYsZr1AKivg\"",
    "mtime": "2026-03-21T18:04:56.104Z",
    "size": 141873,
    "path": "index.mjs"
  },
  "/index.mjs.map": {
    "type": "application/json",
    "etag": "\"8ebdc-5kzm7k71lscvLAt5ARNoVW+zLYA\"",
    "mtime": "2026-03-21T18:04:56.105Z",
    "size": 584668,
    "path": "index.mjs.map"
  }
};
...
const _lazy_uLpQMC = () => Promise.resolve().then(function () { return _id__get$1; });
...
const handlers = [
  ...
  { route: '/api/articles/:id', handler: _lazy_uLpQMC, lazy: true, middleware: false, method: "get" },
...
const DEMO_ARTICLES = [
  {
    ...
    excerpt: "Explore how the latest server-side rendering techniques are reducing Time to Interactive by 40% in modern edge environments.",
    content: `
...
definePageMeta({ ssr: false })</code></pre>
  ...
  },
  {
    ...
    excerpt: "Why logic extraction is the key to maintaining velocity in large-scale Nuxt projects. A deep exploration of composable architecture.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Unlock the full potential of your development environment with these hidden debugging gems inside Nuxt DevTools.",
    content: `
  ...
  },
  {
    ...
    excerpt: "How distributed compute is shifting the way we think about data locality, latency, and security at the network edge.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Strict TypeScript feels brutal at first. Here is why enabling it is the single best investment you can make in a long-lived codebase.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Everything you need to know to migrate a production Vuex 4 store to Pinia without breaking a single component.",
    content: `
      <h2>Why Pinia?</h2>
  ...
  },
  {
    ...
    excerpt: "How to create a scalable, token-driven design system inside a Nuxt 3 monorepo that your whole team can rely on.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Can micro-frontends and island architecture coexist? We explore the emerging patterns that make both possible.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Glassmorphism, tonal layering, and the design philosophy behind building high-end editorial web experiences.",
    content: `
  ...
  },
  {
    ...
    excerpt: "How the WebCrypto API is evolving to meet the demands of a post-quantum digital world\u2014and what you can do today.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Nitro powers every Nuxt 3 deployment. Understanding its internals unlocks performance and architecture improvements you cannot find anywhere else.",
    content: `
      <h2>What Is Nitro?</h2>
  ...
  },
  {
    ...
    excerpt: "Animation is not decoration\u2014it is information. How motion primitives communicate state, hierarchy, and cause-effect to users.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Redefining latency through global edge deployments and Nuxt Nitro engine optimization. A practical guide.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Two dominant aesthetic directions battle for the soul of modern web UI. Which philosophy better serves users today?",
    content: `
  ...
  },
  {
    ...
    excerpt: "Nuxt 3 ships two data-fetching primitives that look similar but serve different purposes. Here is the definitive guide.",
    content: `
      <h2>useFetch</h2>
...
const { data } = await useAsyncData('articles', async () => {
  ...
  },
  {
    ...
    excerpt: "WCAG compliance is a legal requirement for many organizations, but it is also a design opportunity. Building for accessibility makes products better for everyone.",
    content: `
  ...
  },
  {
    ...
    excerpt: "SSR and real-time data are not mutually exclusive. Learn how to build a live-updating dashboard that hydrates instantly and streams data via WebSockets.",
    content: `
...
export default defineWebSocketHandler({
  ...
  },
  {
    ...
    excerpt: "Media queries respond to the viewport. Container queries respond to the parent. This changes how we build responsive components forever.",
    content: `
...
@container (min-width: 400px) {
  ...
  },
  {
    ...
    excerpt: "Optimistic UI updates assume success before the server confirms it. Done right, this makes apps feel instant. Done wrong, it erodes trust.",
    content: `
  ...
  },
  {
    ...
    excerpt: "The convergence of powerful backdrop-filter support, OLED displays, and design-systems maturity is creating a perfect moment for glass-based interfaces.",
    content: `
